          ...
          <div className='profile-body-container'>
            <div className='profile-body'>
              <div className='profile-text'>
                ...
                <h2 className='profile-item-header'>
                  My self-summary
                ...
                <p className={(this.state.summaryIsOpen) ?
                              'hidden' : ''}
                >
                ...
                <form onSubmit={this.handleSubmit}
                      className={(this.state.summaryIsOpen) ?
                ...
                <h2 className='profile-item-header'>
                  ...
                  <button onClick={this.toggleDoing}
                          className='profile-edit-button'>
                  </button>
                </h2>

                <p className={(this.state.doingIsOpen) ?
                              'hidden' : ''}
                >
                ...
                <form onSubmit={this.handleSubmit}
                      className={(this.state.doingIsOpen) ?
                                 'profile-input' : 'hidden'}
                >
                  <textarea name='user'
                            onChange={this.handleInput('doing_with_life')}
                            className='profile-input-text'
                            rows='7'
                            value={`${this.state.user.doing_with_life ||
                                      this.props.currentUser.doing_with_life}`}
                  >
                  </textarea>
                  <button onClick={this.toggleDoing}
                          type='submit'
                ...
                <h2 className='profile-item-header'>
                  I'm really good at
                  <button onClick={this.toggleGood}
                          className='profile-edit-button'>
                  </button>
                </h2>

                <p className={(this.state.goodIsOpen) ?
                              'hidden' : ''}
                >
                ...
                <form onSubmit={this.handleSubmit}
                      className={(this.state.goodIsOpen) ?
                                 'profile-input' : 'hidden'}
                >
                  <textarea name='user'
                            onChange={this.handleInput('good_at')}
                            className='profile-input-text'
                            rows='7'
                            value={`${this.state.user.good_at ||
                                      this.props.currentUser.good_at}`}
                  >
                  </textarea>
                  <button onClick={this.toggleGood}
                          type='submit'
                ...
                <p className={(this.state.favIsOpen) ?
                              'hidden' : ''}
                >
                ...
                <form onSubmit={this.handleSubmit}
                      className={(this.state.favIsOpen) ?
                                  'profile-input' : 'hidden'}
                >
                  <textarea name='user'
                            onChange={this.handleInput('fav_media')}
                            className='profile-input-text'
                            rows='7'
                            value={`${this.state.user.fav_media ||
                                      this.props.currentUser.fav_media}`}
                  >
                  </textarea>
                  <button onClick={this.toggleFav}
                          type='submit'
                ...
                <h2 className='profile-item-header'>
                  ...
                  <button onClick={this.toggleSix}
                          className='profile-edit-button'>
                  </button>
                </h2>

                <p className={(this.state.sixIsOpen) ?
                              'hidden' : ''}
                >
                ...
                <form onSubmit={this.handleSubmit}
                      className={(this.state.sixIsOpen) ?
                        'profile-input' : 'hidden'}
                >
                  <textarea name='user'
                            onChange={this.handleInput('six_things')}
                            className='profile-input-text'
                            rows='7'
                            value={`${this.state.user.six_things ||
                                      this.props.currentUser.six_things}`}
                  >
                  </textarea>
                  <button onClick={this.toggleSix}
                          type='submit'
                ...
                <h2 className='profile-item-header'>
                  ...
                  <button onClick={this.toggleThinking}
                          className='profile-edit-button'>
                  </button>
                </h2>

                <p className={(this.state.thinkingIsOpen) ?
                              'hidden' : ''}
                >
                ...
                <form onSubmit={this.handleSubmit}
                      className={(this.state.thinkingIsOpen) ?
                      'profile-input' : 'hidden'}
                >
                  <textarea name='user'
                            onChange={this.handleInput('thinking_about')}
                            className='profile-input-text'
                            rows='7'
                            value={`${this.state.user.thinking_about ||
                                      this.props.currentUser.thinking_about}`}
                  >
                  </textarea>
                  <button onClick={this.toggleThinking}
                          type='submit'
                ...
                <h2 className='profile-item-header'>
                  ...
                  <button onClick={this.toggleFri}
                          className='profile-edit-button'>
                  </button>
                </h2>

                <p className={(this.state.friIsOpen) ?
                              'hidden' : ''}
                >
                ...
                <form onSubmit={this.handleSubmit}
                      className={(this.state.friIsOpen) ?
                      'profile-input' : 'hidden'}
                >
                  <textarea name='user'
                            onChange={this.handleInput('fri_night')}
                            className='profile-input-text'
                            rows='7'
                            value={`${this.state.user.fri_night ||
                                      this.props.currentUser.fri_night}`}
                  >
                  </textarea>
                  <button onClick={this.toggleFri}
                          type='submit'
                ...
                <p className={(this.state.messageIsOpen) ?
                              'hidden' : ''}
                >
                ...
                <form onSubmit={this.handleSubmit}
                      className={(this.state.messageIsOpen) ?
                                 'profile-input' : 'hidden'}
                >
                  <textarea name='user'
                            onChange={this.handleInput('message_if')}
                            className='profile-input-text'
                            rows='7'
                            value={`${this.state.user.message_if ||
                                      this.props.currentUser.message_if}`}
                  >
                  </textarea>
                  <button onClick={this.toggleMessage}
                          type='submit'
